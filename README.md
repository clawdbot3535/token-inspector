...
- **Real-render tab** (button, table, nav, accordion + card, kbd, badge, progress, switch, checkbox, radio, input, textarea) — a third **`Real`** tab renders an *actual*
...
860 tests across the typed pipeline (`src/` + the `@tg/grammar` package + the Vue app). Run:
